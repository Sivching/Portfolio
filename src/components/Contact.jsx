...
const Contact = () => {
  return (
    <div id="contact" className="h-[100vh] pt-44 ">
      <div className=" w-[90%] xl:w-[80%]  mx-auto ">
        <h1 className="text-4xl lg:text-5xl font-bold text-blue-400 border-b-4 lg:border-b-8 w-[130px] lg:w-[174px] border-blue-400 ">
          Contact
        </h1>
        <h1 className="text-3xl  text-blue-200 xl:text-4xl font-bold text-center mt-10 lg:mt-16">
          Our Information
        </h1>
        <div className=" mx-auto my-20 text-center text-gray-200 px-20 mt-10 grid grid-cols-1 gap-10 lg:grid-cols-3 xl:grid-cols-3  ">
          ...
          <div>
            ...
            <p className="mt-5  font-bold text-xl  ">yisivching@gmail.com</p>
          </div>
          <div>
            <div className="flex justify-center ">
      ...
      <form action="https://getform.io/f/rbeqrmkb" method="POST">
        <div className="mt-10 lg:mt-16 mx-auto">
          <h1 className="text-3xl text-blue-200  xl:text-4xl font-bold text-center">
